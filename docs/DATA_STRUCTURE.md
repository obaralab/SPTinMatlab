...
Measurements here are on a `Project/analysis` build — the only folder in the tree that had actually
been through all four stages — read straight out of the HDF5
