...
%   Tabs: Experiment | Build & QC | Vectors & bleaching.
...
%   analysis/active_trackstruct.txt at it — the build Tool 4 then analyses. Vectors & bleaching
%   reads that build back: step vectors as arrows, and what the intensity traces say about
