function m = spt_measure(raw, xy, rPx)
%SPT_MEASURE  MEAN/MAX/TOTAL intensity over a disk on the raw frame. Port of ERAware measure_spots().
%
%   m = spt_measure(raw, xy, rPx)   ->  m = Nx3 = [MEAN, MAX, TOTAL(sum)]
%
