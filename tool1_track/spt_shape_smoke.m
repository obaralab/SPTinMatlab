...
prm = struct('linkUm',0.8,'gapUm',1.4,'maxGap',1,'erAware',true,'lambda',3,'pxUm',0.10785,'dtS',0.020064,'maxFrames',15);
...
C = spt_curate_read(fullfile(td,'250408_WT_012_spt1_spots.csv'));
spt_curate_write(C, C.len>=1, td, '250408_WT_012_spt1');
