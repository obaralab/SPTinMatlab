function [readPage, closeFile] = spt_tiff_pages(path)
%SPT_TIFF_PAGES  Read pages of a multi-page TIFF through ONE open file handle.
%
%   [readPage, closeFile] = spt_tiff_pages(path)
