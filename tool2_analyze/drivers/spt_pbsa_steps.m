function R = spt_pbsa_steps(y, varargin)
%SPT_PBSA_STEPS  Find discrete photobleaching steps in an intensity trace (Kalafut-Visscher + SIC).
%
%   R = spt_pbsa_steps(y)
%   R = spt_pbsa_steps(y, 'MinStep', h, 'MaxSteps', n, 'Verbose', tf)
%
