...
for i=1:size(Files,1)
   ...
   if MitoFlag==1
     save(fullfile(outputDir,strcat(stripSuffix(filename,'_CSdata.mat'),'_mito_','CSdata.mat')),'CSdata');
   elseif MitoFlag==-1
     save(fullfile(outputDir,strcat(stripSuffix(filename,'_CSdata.mat'),'_other_','CSdata.mat')),'CSdata');
   else
